...
def train(args):
    writer = SummaryWriter(os.path.join('logs/fusion_ode', args.name))
    ...
    os.makedirs(os.path.join('checkpoints/fusion_ode', args.name), exist_ok=True)
    for epoch in range(args.max_epochs):
        ...
        torch.save(model.state_dict(), os.path.join('checkpoints/fusion_ode', args.name, f'{epoch}.pth'))
