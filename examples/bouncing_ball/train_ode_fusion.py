...
def train(args):
    writer = SummaryWriter(os.path.join('logs/ode_fusion', args.name))
    os.makedirs(os.path.join('checkpoints/ode_fusion', args.name), exist_ok=True)
    ...
    for epoch in range(args.max_epochs):
        ...
        torch.save(model.state_dict(), os.path.join('checkpoints/ode_fusion', args.name, f'{epoch}.pth'))
